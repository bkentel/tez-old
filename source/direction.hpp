...
struct get_x_axis_vector : public get_axis_vector_base<x_axis, Dir> {};

template <direction Dir>
struct get_y_axis_vector : public get_axis_vector_base<y_axis, Dir> {};

template <direction Dir>
struct get_z_axis_vector : public get_axis_vector_base<z_axis, Dir> {};
//==============================================================================
#define BK_SPECIALIZE_AXIS(XYZ, D, V) \
template <> struct get_##XYZ##_axis_vector<D> \
    : public get_axis_vector_base<##XYZ##_axis, D, V> {}
